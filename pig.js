...
function controlDice(dice) {
  ...
  if (isBot && currentScore > expectedScoreOfBot) {
    onHold();
...
function onStart() {
  ...
  if (
    ...
    message.innerHTML = "Ikkalasi ham bot bolishi mumkin emas";
...
function startBOT() {
  expectedScoreOfBot = Math.floor(Math.random() * 20) + 10; // [10,29]
  interval = setInterval(() => onRollDice(), 2000);
}
